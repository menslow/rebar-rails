// Fetched from channel: tags/v1.0.0-beta.10, with url http://builds.emberjs.com/tags/v1.0.0-beta.10/ember-data.js
// Fetched on: 2014-09-15T19:31:10Z
(function(global){
...
define("ember-data/serializers/utils",
  ["exports"],
  function(__exports__) {
    "use strict";
    // checks config for attrs option to serialize records
    function noSerializeOptionSpecified(attrs, attr) {
      ...
      return option && (option.serialize === false);
    }
    ...
    __exports__.attrsOption = attrsOption;
    __exports__.noSerializeOptionSpecified = noSerializeOptionSpecified;
  });
